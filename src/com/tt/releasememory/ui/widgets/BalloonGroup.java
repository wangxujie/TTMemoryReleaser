...
import com.tt.releasememory.helpers.BalloonHelper;
...
public class BalloonGroup {
    ...
    private void addContent() {
        for (int i = 0; i < ConfigHelper.getBalloonCount(); i++) {
            int[] pos = BalloonHelper.getBallonPosByRandom(mWindowManager);
            int[] size = BalloonHelper.getBallonSizeByRandom(mWindowManager);
    ...
    /**
     * @param 对mOnBalloonFlyedListener进行赋值
     */
