...
import com.tt.releasememory.ui.widgets.BalloonGroup.OnBalloonFlyedListener;
import com.tt.releasememory.ui.widgets.HandView.onHandMovedListener;
import com.tt.releasememory.ui.widgets.HandView.onLooseListener;
import com.tt.releasememory.ui.widgets.LineView.OnLinePackedListener;
            ...
            protected void onPostExecute(Long result) {
                ...
                if (result <= 0) {
                    ...
                    s = "已经为您清理" + "<font color='#4898eb'>"
                            + Formatter.formatShortFileSize(mContext, result)
                            + "</font>" + "内存！";
                }
                ReleaseToast.showToast(mContext, Html.fromHtml(s));
                //                MobclickAgent.onEvent(mContext, LogConfig.RELEASE_MEMORY);
            }
        };
