...
public class BalloonHelper {
     ...
     * @return
     */
    public static int[] getBallonPosByRandom(WindowManager manager) {
        int[] pos = new int[2];
     ...
     * @return
     */
    public static int[] getBallonSizeByRandom(WindowManager manager) {
        int minWidth = getMinWidth(manager);
     ...
     * @return
     */
    public static int getMaxHeight(WindowManager manager) {
        int minWidth = getMinWidth(manager);
    ...
    public static long getRandomFlyDuration() {
        return (long) (ConfigHelper.getBalloonDuration() + Math.random()
                * ConfigHelper.getBalloonDuration());
    }

    private static final float FLOAT_W = 0.3f;

    private static int getMinWidth(WindowManager manager) {
        int minWidth = (int) (manager.getDefaultDisplay().getWidth() / (ConfigHelper
                .getBalloonCount() * (1 + FLOAT_W)));
        return minWidth;
    }
}
